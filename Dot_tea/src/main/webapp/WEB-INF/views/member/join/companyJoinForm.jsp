...
<body class="member-join" oncontextmenu="return false"
		...
		<div id="content">
			...
			<div class="page_aticle">
				...
				<div class="page_location">
					<a class="link"
						href="${pageContext.request.contextPath}/shop/TeaRecommendList.tea">홈</a>
					&gt; <a class="link"
						href="${pageContext.request.contextPath}/join/jointype.tea">회원가입</a>
					&gt; <strong class="current">회원가입</strong>
				</div>

				<div class="head_section head_join">
					<h2 class="tit">기업 회원가입</h2>
				</div>

				<div class="member_join">
					<div class="">
						<form id="form" name="MemberComJoin" method="post"
							action="${pageContext.request.contextPath}/join/companyJoin.tea"
							...
							<div class="boardWrite">
								<table class="tbl_comm">
									...
									<tbody>
										...
										<tr>
											<td class="memberCols1">기업 아이디*</td>
											<td class="memberCols2"><input type="text"
												name="MEM_COM_ID" id="MEM_COM_ID" maxlength="16"
												oninput="value=value.slice(0,20);$(this).val($(this).val().replace(/[^0-9,a-z,!-@]/g,''));"
												placeholder="예: marketkurly12" /> <a href="#this"
												id="chk_id"><span class="bhs_button">중복확인</span></a></td>
										</tr>
										<tr>
											<td colspan="1"></td>
										...
										<tr>
											...
											<td class="memberCols2"><input type="password"
												...
												oninput="value=value.slice(0,20);$(this).val($(this).val().replace(/[^0-9,a-z,!-@]/g,''));"
												option="regPass" maxlength="16" placeholder="비밀번호를 입력해주세요."></td>
										</tr>
										<tr>
										...
										<tr>
										<tr class="mobile">
											<td class="memberCols1">담당자 휴대폰*</td>
											<td class="memberCols2">
												<div class="phone_num">
													<input type="text" value="" pattern="[0-9]*"
														name="MEM_COM_MANAGER_PHONE" id="MEM_COM_MANAGER_PHONE"
														maxlength="11"
										...
										<tr>
											...
											<td class="memberCols2"><input type="text"
												name="MEM_COM_MANAGER_EMAIL" id="MEM_COM_MANAGER_EMAIL"
												value="" size="30" option="regEmail" label="이메일"
							...
							<div class="field_head head_type2">
								<h3 class="tit">사업 관련 항목*</h3>
								<p class="sub">사업장에 관한 데이터를 입력 해주세요.</p>
							</div>

							<div class="boardWrite">
								<table class="tbl_comm2">
									<tr class="mobile">
										<td class="memberCols1">사업장 전화번호</td>
										<td class="memberCols2">
											<div class="phone_num">
												<input type="text" value="" pattern="[0-9]*"
													name="MEM_COM_COMPANY_PHONE" id="MEM_COM_COMPANY_PHONE"
													maxlength="12"
													oninput="if(value.length>12)value=value.slice(0,11);$(this).val($(this).val().replace(/[^0-9]/g,''));"
													placeholder="'-' 없이 숫자만 입력해주세요." class="inp">
											</div>
										</td>
									</tr>
									...
									<tr class="mobile">
										<td class="memberCols1">대표명*</td>
										<td class="memberCols2"><input type="text"
											name="MEM_COM_OWNER" id="MEM_COM_OWNER" value=""
											placeholder="예: 홍길동 "></td>
									</tr>

									<tr class="mobile">
										<td class="memberCols1">사업장명*</td>
										<td class="memberCols2"><input type="text"
											name="MEM_COM_NAME" id="MEM_COM_NAME" value=""
											placeholder="예: 티마켓 "></td>
									</tr>

									<tr class="mobile">
										<td class="memberCols1">사업자 번호*</td>
										<td class="memberCols2">
											<div class="phone_num">
												<input type="text" value="" pattern="[0-9]*"
													name="MEM_COM_RESI" id="MEM_COM_RESI"
													placeholder="'-' 없이 입력 해주세요." class="inp"> <a
													href="#this" id="resi_find"><span class="bhs_button">사업자
														번호 확인</span></a>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<!-- <div name="ch_resi_div" id="ch_resi_div"></div> -->
									</tr>

									<tr class="mobile">
										<td class="memberCols1">통신판매 번호*</td>
										<td class="memberCols2">
											<div class="phone_num">
												<input type="text" value="" name="MEM_COM_COMNUM"
													id="MEM_COM_COMNUM" placeholder="ex)0000-서울강남-0000"
													class="inp"> <a href="#this" id="comNum"><span
													class="bhs_button">통신판매 번호 확인</span></a>
											</div>
										</td>
									</tr>
									...
									<tr class="mobile">
										<td class="memberCols1">팩스 번호</td>
										<td class="memberCols2">
											<div class="phone_num">
												<input type="text" value="" pattern="[0-9]*"
													id="MEM_COM_FAX" name="MEM_COM_FAX"
													oninput="value=value.slice(0,11);$(this).val($(this).val().replace(/[^0-9]/g,''));"
													placeholder="'-' 없이 숫자만 입력해주세요." class="inp">
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td class="memberCols2"><input type="text"
											...
											value="" size="30" placeholder="예: marketkurly@kurly.com">
											<a href="#this" id="chk_com_email"> <span
												class="bhs_button">이메일 중복확인</span></a></td>
									</tr>
									...
									<tr>
										<td class="memberCols1">사업장 주소*</td>
										<td class="memberCols2">
									...
									<tr class="mobile">
										<td class="memberCols1">기업 계좌 번호*</td>
										<td class="memberCols2"><input type="text"
											name="account1" id="account1" placeholder="은행" class="inp">
											<input type="text" value="" pattern="[0-9]*" name="account2"
											id="account2" placeholder="'-' 없이 숫자만 입력해주세요." class="inp"></td>
									</tr>

									<tr class="mobile">
										<td class="memberCols1">배달비 커트라인</td>
										<td class="memberCols2"><input type="text"
											pattern="[0-9]*" name="MEM_COM_DELIVERYFREE"
											id="MEM_COM_DELIVERYFREE"
											oninput="value=value.slice(0,11);$(this).val($(this).val().replace(/[^0-9]/g,''));"
											placeholder="예: 50000 ">
									</tr>
							...
							<div class="reg_agree">
								<div class="check">
									<label> <input type="checkbox" id="agree_allcheck"
										name="agree_allcheck" class="styled-checkbox-black"> <span
										class="txt_checkbox">전체동의</span>
									</label>
								</div>
							...
							<div id="avoidDbl">
								<!-- 	<a href="#this" id="btn_submit"><span class="bhs_button">가입하기</span></a>-->
	...
	<script src="<c:url value='/js/joinCompany.js'/>" charset="utf-8"></script>
		...
		function zipCheck() {
			...
			new daum.Postcode(
				...
				+"name='MEM_COM_LOADADDR' id='MEM_COM_LOADADDR' option='regId' value='"+data.roadAddress+"'/></td></tr>";
							str += "<tr><td class='memberCols1'>기업 상세 주소 </td><td class='memberCols2'><input type='text'"
						...
						function() {
							...
							$("#chk_id")
									.on(
											...
											function(e) {
												e.preventDefault();
												var inputId = document.MemberComJoin.MEM_COM_ID.value;
												idCk = 0;
												if (inputId.length > 2) {
													chk_id(inputId);
												} else {
							...
							$("#btn_submit")
									.on(
											...
											function(e) {
												...
												comSubmit
														.setUrl("<c:url value='/join/companyJoin.tea'/>");
												comSubmit.submit();
											});
							$("#btnAddressSearch").on("click", function(e) {
								e.preventDefault();
							...
							$("#comNum")
									.on(
											...
											function(e) {
												e.preventDefault();
												var body = document
														.getElementById("ch_sellNumber_div");
												body.innerHTML = "";
												companySellNumber();
											});
							...
							$("#chk_email")
									.on(
											...
											function(e) {
												e.preventDefault();
												var inputEmail = document.MemberComJoin.MEM_COM_MANAGER_EMAIL.value;
												Man_email = 0;
							...
							$("#chk_com_email")
									.on(
											...
											function(e) {
												e.preventDefault();
												var inputEmail2 = document.MemberComJoin.MEM_COM_COMPANY_EMAIL.value;
												com_email = 0;
	...
	<script type="text/javascript">
		...
		function companySellNumber() {
			...
			} else if (document.MemberComJoin.MEM_COM_COMNUM.value == "") {
