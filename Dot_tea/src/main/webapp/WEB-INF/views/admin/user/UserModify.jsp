		...
		<div class="orderArea">
			...
			<div class="boardWrite">
				<form id="jform" name="jform">
					...
					<table border="1" summary="" style="width: 70%">
						...
						<tbody>
							...
							<tr>
								...
								<td><input name="MEM_USER_PASSWORD" type="text"
									value="${map.MEM_USER_PASSWORD}" required autofocus
							...
							<tr>
								...
								<td><input type="text" id="MEM_USER_BLACK"
									name="MEM_USER_BLACK" value="${map.MEM_USER_BLACK }"
									style="font-size: 15px" /></td>
							</tr>
				...
				.ready(
						function() {
							...
							function fn_openBoardList() {
								...
								comSubmit
										.setUrl("<c:url value='/admin/UserList.tea' />");
								comSubmit.submit();
							}
							...
							function fn_updateBoard() {
								...
								comSubmit
										.setUrl("<c:url value='/admin/UserModify.tea' />");
								comSubmit.submit();
							}
