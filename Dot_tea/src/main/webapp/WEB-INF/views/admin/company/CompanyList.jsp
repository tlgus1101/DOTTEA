...
<div class="row">
	<h1 class="page-header">회원 목록(Company)</h1>
	<div style="float: right;">
		<a href="#this" class="button" id="Main">Main</a>
	</div>
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">회원 목록(Company) 입니다.</div>
				...
				<table class="table  table-bordered table-hover dataTable no-footer"
					...
					<thead>
						<tr style="vertical-align: middle; border: 1px solid lightgray;">
							...
							<th
								style="width: 15%; text-align: center; vertical-align: middle; border: 1px solid lightgray;">관리</th>
						</tr>
					</thead>
...
<script type="text/javascript">
	...
	function fn_searchKeyword(obj) {
		...
		comAjax.setUrl("<c:url value='/admin/CompanyList.tea'/>");
	...
	function fn_selectBoardList(pageNo) {
		var comAjax = new ComAjax();
		comAjax.setUrl("<c:url value='/admin/selectCompanyList.tea' />");
		comAjax.setCallback("fn_selectBoardListCallback");
	...
	function fn_deleteBoard(obj) {
		var comSubmit = new ComSubmit();
		comSubmit.setUrl("<c:url value='/admin/CompanyDelete.tea' />");
		comSubmit
				.addParam("MEM_COM_NO", obj.parent().find("#MEM_COM_NO").val());
		comSubmit.submit();
