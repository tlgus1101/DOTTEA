...
<div class="row">
	<h1 class="page-header">신고 게시판(후기/신고 접수)</h1>
	<div style="float: right;">
		<a href="#this" class="button" id="Main">Main</a>
	</div>
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">신고 게시판(후기/신고 접수) 입니다.</div>
			<div id="container">
				<ul class="tabs">
		...
		<script type="text/javascript">
			...
			function fn_searchKeyword(obj) {
				...
				comAjax.setUrl("<c:url value='/admin/ReportUserList1.tea'/>");
			...
			function fn_selectBoardList(pageNo) {
				var comAjax = new ComAjax();
				comAjax
						.setUrl("<c:url value='/admin/selectReportUserList1.tea' />");
				comAjax.setCallback("fn_selectBoardListCallback");
