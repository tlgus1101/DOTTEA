...
<body>
	...
	<div id="container">
    <ul class="tabs">
        <li class="active" rel="tab1"><a href="<c:url value='/admin/ReportUserList.tea'/>">전체</a></li>
        <li class="active" rel="tab2"><a href="<c:url value='/admin/ReportBlUserList.tea'/>">블랙</a></li>
    </ul>
   ...
   <!--  <div id="tab1" class="tab_content">
    ...
    var count=10;
    	...
    	function fn_searchKeyword(obj) {
    				...
    				comAjax.setUrl("<c:url value='/admin/ReportBlUserList.tea'/>");
        ...
        function fn_selectBoardList(pageNo){
            var comAjax = new ComAjax();
            comAjax.setUrl("<c:url value='/admin/selectReportBlUserList.tea' />");
            comAjax.setCallback("fn_selectBoardListCallback");
