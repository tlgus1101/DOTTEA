...
<div class="row">
	<h1 class="page-header">블랙 회원 목록(User)</h1>
	<div style="float: right;">
		<a href="#this" class="button" id="Main">Main</a>
	</div>
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">블랙 회원 목록(User) 입니다.</div>
				...
				<table class="table  table-bordered table-hover dataTable no-footer"
					...
					<thead>
						<tr style="vertical-align: middle; border: 1px solid lightgray;">
							...
							<th
								style="width: 10%; text-align: center; vertical-align: middle; border: 1px solid lightgray;">이름</th>
							<th
...
<script type="text/javascript">
	...
	function fn_searchKeyword(obj) {
		...
		comAjax.setUrl("<c:url value='/admin/BlUserList.tea'/>");
	...
	function fn_policeList(obj) {
		var comSubmit = new ComSubmit();
		comSubmit.setUrl("<c:url value='/admin/BlUserPoliceList.tea' />");
		comSubmit.addParam("MEM_USER_NO", obj.parent().find("#MEM_USER_NO")
				.val());
		comSubmit.submit();
	}
	...
	function fn_deleteBoard(obj) {
		var comSubmit = new ComSubmit();
		comSubmit.setUrl("<c:url value='/admin/BlUserDelete.tea' />");
		comSubmit.addParam("MEM_USER_NO", obj.parent().find("#MEM_USER_NO")
				.val());
		comSubmit.submit();
	...
	function fn_openBoardDetail(obj) {
		var comSubmit = new ComSubmit();
		comSubmit.setUrl("<c:url value='/admin/BlUserView.tea' />");
		comSubmit.addParam("MEM_USER_NO", obj.parent().find("#MEM_USER_NO")
				.val());
		comSubmit.submit();
	}
	...
	function fn_selectBoardList(pageNo) {
		var comAjax = new ComAjax();
		comAjax.setUrl("<c:url value='/admin/selectBlUserList.tea' />");
		comAjax.setCallback("fn_selectBoardListCallback");
					...
					.each(
							...
							function(key, value) {
								str += "<tr>" + "<td align=center>"
										...
										+ "</td>"
										+ "<td align=center>"
										+ value.MEM_USER_USERNAME
										+ "</td>"
										+ "<td align=center>"
										+ value.MEM_USER_PHONE
										+ "</td>"
										+ "<td class= 'black' align=center>"
										+ "<a href='#this' name='black'>"
										+ value.MEM_USER_BLACK
										+ "</a>"
