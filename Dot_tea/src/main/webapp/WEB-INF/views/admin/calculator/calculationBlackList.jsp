...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/hotel/form.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/user/userForm.css">
<link
	href="${pageContext.request.contextPath}/resources/css/adminItem/bootstrapadmin.min.css"
...
/* 占쏙옙占쎌스 占시뤄옙占쏙옙占쏙옙 占쏙옙 占쏙옙占싹는곤옙 */
.btn-primary:hover {
	color: #fff;
	background-color: #ffab3d;
	border-color: #ffab3d
...
<body style="margin: 10px 30px">
	<div class="row">
		<h1 class="page-header" align="center" >블랙 기업 정산</h1>
	</div>
	<form name=frm>
		<div class="row">
				...
				<div id="dataTables-example_wrapper" class="panel-body">
					<table
						...
						<tr style="vertical-align: middle; border: 1px solid lightgray;">
							...
							<td align="center">기업 코드</td>
							<td align="center">기업 이름</td>
							<td align="center">정산액</td>
						</tr>
		...
		<select name="searchType" id="searchType">
			<option value="1">기업코드</option>
			<option value="2">기업이름</option>
	...
	<script src="<c:url value='/js/calculation.js'/>" charset="utf-8"></script>
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(function() {
				$("a.button1").click(function() {
					$("a.button1").removeClass("active").css("color", "#333");
		...
		function fn_perMonth(obj) {
			...
			comAjax.setUrl("<c:url value='/admin/CalculatorBList.tea' />");
			comAjax.setCallback("calculationBListCallback");
		...
		function fn_openBoardDetail(obj) {
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/admin/CompanyView.tea' />");
			comSubmit.addParam("MEM_COM_NO", obj.parent().find("#MEM_COM_NO")
					.val());
			comSubmit.submit();
		}

		function calculationBListCallback(data) {
