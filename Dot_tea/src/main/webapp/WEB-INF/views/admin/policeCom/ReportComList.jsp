...
<div class="row" >
	<h1 class="page-header">신고게시판(상품)</h1>
...
<div class="row">
    ...
    <ul class="tabs">
        ...
        <li class="active" rel="tab2"><a href="<c:url value='/admin/ReportComList1.tea'/>">신고 접수</a></li>
    </ul>
				...
				aria-describedby="dataTables-example_info">
					<thead>
						<tr style="vertical-align:middle; border:1px solid lightgray;">
							<th style="width: 5%; text-align:center;vertical-align:middle; border:1px solid lightgray;">번호</th>
							<th style="width: 10%; text-align:center;vertical-align:middle; border:1px solid lightgray;">제목</th>
							<th style="width: 5%; text-align:center;vertical-align:middle; border:1px solid lightgray;">신고자</th>
							<th style="width: 5%; text-align:center;vertical-align:middle; border:1px solid lightgray;">신고일자</th>
							<th style="width: 5%; text-align:center;vertical-align:middle; border:1px solid lightgray;">상태</th>
							<th style="width: 5%; text-align:center;vertical-align:middle; border:1px solid lightgray;">관리</th>
						</tr>
					</thead>
    ...
    var count=10;
    	...
    	function fn_searchKeyword(obj) {
    		/* 		var comSubmit = new ComSubmit();
    				...
    				comAjax.setUrl("<c:url value='/admin/ReportComList.tea'/>");
    	...
    	function fn_Main(){
    	 ...
    	 function fn_openBoardDetail(obj){
    		 var comSubmit = new ComSubmit();
             var P_COM_NO = obj.parent().find("#P_COM_NO").val();
             var MEM_COM_NO = obj.parent().find("#MEM_COM_NO").val();
             var url = "http://localhost:8080/Dot_tea/admin/ReportComView.tea?P_COM_NO="+P_COM_NO+"&MEM_COM_NO="+MEM_COM_NO;
        ...
        function fn_selectBoardList(pageNo){
            var comAjax = new ComAjax();
            comAjax.setUrl("<c:url value='/admin/selectReportComList.tea' />");
            comAjax.setCallback("fn_selectBoardListCallback");
        ...
        function fn_selectBoardListCallback(data){
            ...
            if(total == 0){
                ...
                $.each(data.list, function(key, value){
                	str += "<tr>" +
                    "<td align=center>" + value.P_COM_NO + "</td>" +
                    "<td align=center>" + value.P_COM_SUBJECT + "</td>" +
                    "<td align=center>" + value.P_REPORTER_ID + "</td>" +
                    "<td align=center>" + value.P_COM_DATE + "</td>" ;
