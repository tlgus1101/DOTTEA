...
<body>
	<div id="ContextJoinForm" align="center">
		...
		<div class="orderArea">
				...
				<form id="jform" name="jform">
					...
					<table border="1" summary="" style="width: 60%">
						...
						<tbody>
							...
							<tr>
								<th scope="row">번호</th>
								<td>${map.P_COM_NO }<input type="hidden" id="P_COM_NO"
									name="P_COM_NO" value="${map.P_COM_NO }"> <input
									type="hidden" id="MEM_COM_NO" name="MEM_COM_NO"
							...
							<tr>
								...
								<td>${map.P_COM_CONTENT }</td>
							</tr>

							<tr>
								<th scope="row">거절 사유</th>
								<td><textarea rows="20" cols="100" title="내용"
										id="P_COM_REFUSAL" name="P_COM_REFUSAL">${map.P_COM_REFUSAL }</textarea>
								</td>
							</tr>
			...
			<br> <a href="#this" class="button" id="update" >거절</a> <a
				href="#this" class="button" id="list" onclick="javascript()">목록</a>
	...
	<script type="text/javascript">
		...
		function fn_updateBoard() {
			...
			comSubmit.setUrl("<c:url value='/admin/ComUpdateStatus2.tea' />");
			comSubmit.submit();
