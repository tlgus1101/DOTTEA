...
<div class="row">
	<h1 class="page-header">신고 게시판(상품/신고 접수)</h1>
	<div style="float: right;">
		<a href="#this" class="button" id="Main">Main</a>
	</div>
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">신고 게시판(상품/신고 접수) 입니다.</div>
			<div id="container">
				<ul class="tabs">
					<li class="active" rel="tab1"><a
						href="<c:url value='/admin/ReportComList.tea'/>">전체</a></li>
					<li class="active" rel="tab2"><a
						href="<c:url value='/admin/ReportComList1.tea'/>">신고 접수</a></li>
				</ul>
		...
		<script type="text/javascript">
			...
			function fn_searchKeyword(obj) {
				...
				comAjax.setUrl("<c:url value='/admin/ReportComList1.tea'/>");
			...
			function fn_openBoardDetail(obj) {
				...
				var url = "http://localhost:8080/Dot_tea/admin/ReportComView.tea?P_COM_NO="
						+ P_COM_NO + "&MEM_COM_NO=" + MEM_COM_NO;
			...
			function fn_selectBoardList(pageNo) {
				var comAjax = new ComAjax();
				comAjax
						.setUrl("<c:url value='/admin/selectReportComList1.tea' />");
				comAjax.setCallback("fn_selectBoardListCallback");
