				...
				<form id="success_find_id">
					<div
						...
						<div class="login">
							...
							<ul class="text">
								<li></li>
								<li><span>귀하의 ID는 </span></li>
							</ul>
							<ul>
								<li></li>
								<strong> <font color="#4b0082"><li>"
											${findedId} "</strong>
								</li>
								</font>
							</ul>
							...
							<ul>
								<li><a class="link"
									href="${pageContext.request.contextPath}/login/loginForm.tea">
										<button type="button" id="toLogin" class="bhs_button">로그인
											하러 가기</button>
								</a></li>
								<li><a class="link"
									href="${pageContext.request.contextPath}/login/findPwForm.tea">
										<button type="button" id="toLogin" class="bhs_button">비밀번호
											찾으러 가기</button>
								</a></li>
							</ul>
						</div>
