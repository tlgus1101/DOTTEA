...
function ComSubmit2(opt_formId) {
	this.formId = gfn_isNull(opt_formId) == true ? "commonForm" : opt_formId;
	this.url = "";
...
// if(totalIndexCount > 10){ // 전체 인덱스가 10이 넘을 경우, 맨앞, 앞 태그 작성
// preStr += "<a href='#this' class='layout-pagination-button
// layout-pagination-first-page' onclick='_movePage(1,"+type+")'></a>" +
// "<a href='#this' class='layout-pagination-button layout-pagination-prev-page'
// onclick='_movePage("+prev+","+type+")'></a>";
// }
// else if(totalIndexCount <=10 && totalIndexCount > 1){ // 전체 인덱스가 10보다
// // 작을경우, 맨앞 태그 작성
// preStr += "<a href='#this' class='layout-pagination-button
...
//     
// if(totalIndexCount > 10){ // 전체 인덱스가 10이 넘을 경우, 맨뒤, 뒤 태그 작성
// postStr += "<a href='#this' class='layout-pagination-button
// layout-pagination-next-page' onclick='_movePage("+next+","+type+")'></a>" +
// "<a href='#this' class='layout-pagination-button layout-pagination-last-page'
// onclick='_movePage("+totalIndexCount+","+type+")'></a>";
// }
// else if(totalIndexCount <=10 && totalIndexCount > 1){ // 전체 인덱스가 10보다
// // 작을경우, 맨뒤 태그 작성
// postStr += "<a href='#this' class='layout-pagination-button
...
// for(var i=first; i<(first+last); i++){
// if(i != currentIndex){
// str += " <a href='#this' class='layout-pagination-button
// layout-pagination-number' onclick='_movePage("+i+","+type+")'>"+i+" </a>";
// }
// else{
// str += "<b> <a href='#this' class='layout-pagination-button
// layout-pagination-number' onclick='_movePage("+i+","+type+")'>"+i+"</a>
// </b>";
// }
// }
...
function _movePage(value,type){
    $("#"+gfv_pageIndex).val(value);
    if(typeof(gfv_eventName) == "function"){
        gfv_eventName(value,type);
    }
    else {
        eval(gfv_eventName + "(value,type);");
    }
}
